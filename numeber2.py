...
def  btnClicked():
    global entryCd,opnum,cd,message,txt1
    cd = int(entryCd.get())
...
def update():
    msgbox.showinfo("提示", "小了，你大脑瓜子怎么想的! !")
def update_big():
    msgbox.showinfo("提示", "大了，你小脑瓜子怎么想的!")
def update_small():
    msgbox.showinfo("提示", "小了，你大脑瓜子怎么想的! !")
def update_binggo():
...
def main_soneui():
    ...
    num=Label(root1, text='txt1',bg='#3f8dbb' ,heigh=2,width=60,font=root1.my_fonto).place(x=26,y=110)
    labelHello=tk.Label(root1, text="txt2",bg='#3f8dbb' , heigh=2,width=60,font=root1.my_fonto)
    labelHello.place(x=26,y=170)
    opnum=Label(root1, text="txt3",bg='#3f8dbb' , heigh=2,width=60,font=root1.my_fonto)
